...
import { faLocation, faClock, faPaperPlane, faHandshake, faFaceAngry } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="bigone container-fluid d-flex flex-column align-items-center justify-content-center p-2 m-2">
            <div className="row w-90 text-center justify-content-center">
                <div className="col-12 col-md-10 col-lg-8 m-4">
                    ...
                    <div className="d-flex justify-content-center p-2">
                        <div className="card" style={{ width: "100%", maxWidth: "20rem" }}>
                            ...
                            {selectedoption === "option1" && (
                                <div className="p-2">
                                    <img src="https://media.tenor.com/tgCokuvCJJsAAAAM/marivi-bilbao.gif" alt="anhqv" className="gif m-1" />
                                    <a href="https://forms.gle/jT9ADGdHP8bS7hs26" target="_blank" rel="noopener noreferrer" className="btn btn-success boton3 p-1 m-2">Vamos <FontAwesomeIcon className="" icon={faHandshake} /> </a>
                                </div>
                            )}
                            {selectedoption === "option2" && (
                                <div>
                                    ...
                                    <a href="https://forms.gle/jT9ADGdHP8bS7hs26" target="_blank" rel="noopener noreferrer" className="btn btn-success boton3 p-1 m-2">Decídete <FontAwesomeIcon className="" icon={faFaceAngry} /> </a>
                                </div>
                            )};
                    ...
                    <div className="mt-3 m-2 d-flex flex-column align-items-center">
                        <iframe
                    ...
                    {/* Activar más tarde y renovar cada 7 días el Spotify*/}
                    {/* <div className="p-3">
