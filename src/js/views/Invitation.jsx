        ...
        <div className="bigone container-fluid d-flex flex-column align-items-center justify-content-center p-2 m-2">
            <div className="row w-90 text-center justify-content-center">
                <div className="col-12 col-md-10 col-lg-8 m-4">
                    ...
                    <div className="d-flex justify-content-center p-2">
                        <div className="card" style={{ width: "100%", maxWidth: "18rem" }}>
                            ...
                            <div className="card-body">
                                ...
                                {/* Meter un alert para cuando esté disponible */}
                                {/* Que aparezca si dicen que sí vienen a la boda */}
                                <a href="https://forms.gle/4Qdz2yLdEngH3U6aA" className="btn btn boton1 p-2" target="_blank" rel="noopener noreferrer">Formulario</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-3">
                        <p>Sí, tu presencia es suficiente ya los sabes, pero oye, si te apetece contribuir y tal...
